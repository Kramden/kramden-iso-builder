...
livefs-edit $in out/spec0.iso --add-apt-repository ppa:kramden-team/kramden --install-packages guvcview python3-psutil python3-pyudev python3-reportlab python3-requests kramden-device kramden-provision kramden-spec nvme-cli cheese nwipe
